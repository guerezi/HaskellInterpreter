...
happyExpList = Happy_Data_Array.listArray (0,49) ([53360,32,0,15360,0,0,7168,14388,28776,208,0,0,124,3335,6670,13340,26680,0,0,0,0,1792,61453,4,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","true","false","num","'+'","'&'","'?'","'*'","'|'","'{'","'}'","\"fst\"","\"snd\"","%eof"]
...
action_9 (11) = happyShift action_15
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenMult -> cont 11;
	TokenPair -> cont 12;
	TokenPairOpen -> cont 13;
	TokenPairClose -> cont 14;
	TokenFirst -> cont 15;
	TokenSecond -> cont 16;
	_ -> happyError' ((tk:tks), [])
	}
